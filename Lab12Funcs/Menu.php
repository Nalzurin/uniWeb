...
<header class="u-clearfix u-gradient u-header u-sticky u-sticky-bc77 u-header" id="sec-8a2c">
        <div class="u-clearfix u-sheet u-sheet-1">
            ...
            </nav><span class="u-icon u-text-white u-icon-1">
                      <button name="AddButton" id="AddButton" style="background:0;   border: none;">
                          <img src="images/Add.png" style="width: 57px; height: 57px;" />
                      </button> 
                  </span><span class="u-icon u-text-white u-icon-2">
                             <button name="SearchButton" id="SearchButton" style="background:0;   border: none;">
                                 <img src="images/Search.png" style="width: 57px; height: 57px;" />
                             </button>
                         </span>
              </div>
      </header>